/***************************************************************************
	BT-BLE Data Transmission.c
	Author: Meghadoot
  	2024-12-22
	
	This is a library for the validation of Bluetooth Interface.
	This validation test uses gatttol to test sample data transfer.
...
int main() {
    printf("Starting Bluetooth BLE Data Transmission Test...\n");

    // Replace XX:XX:XX:XX:XX:XX with the Bluetooth address of the target device
    // Replace 0x0001 with the handle of the characteristic to write
    system("gatttool -b XX:XX:XX:XX:XX:XX --char-write-req --handle=0x0001 --value=0100");

    printf("Bluetooth BLE Data Transmission Test completed.\n");
    return 0;
}
