/***************************************************************************
	BT-BLE Data Reception.c
	Author: Meghadoot
  	2024-12-22
	
	This is a library for the validation of Bluetooth Interface.
	This validation test uses gatttol to test sample data reception.
...
int main() {
    printf("Starting Bluetooth BLE Data Reception Test...\n");

    // Replace XX:XX:XX:XX:XX:XX with the Bluetooth address of the target device
    // Replace 0x0001 with the handle of the characteristic to read
    system("gatttool -b XX:XX:XX:XX:XX:XX --char-read --handle=0x0001");

    printf("Bluetooth BLE Data Reception Test completed.\n");
    return 0;
}
